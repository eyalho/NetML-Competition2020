...
from vpn_top_mid_fine import fine_to_top


class LoadFineForTopScaled(ABSClassifier):
    def __init__(self):
    ...
    def train(self, X_train, X_val, y_train, y_val):
        ...
        print("Training Score: \t{:.5f}".format(self.clf.score(X_train_scaled, fine_to_top(y_train))))
        X_val_scaled = self.scaler.transform(X_val)
        print("Validation Score: \t{:.5f}".format(self.clf.score(X_val_scaled, fine_to_top(y_val))))
    ...
    def predict(self, X):
        ...
        ypred = fine_to_top(self.clf.predict(X_scaled))
